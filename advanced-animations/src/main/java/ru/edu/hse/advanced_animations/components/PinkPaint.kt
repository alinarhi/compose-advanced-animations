...
import ru.edu.hse.advanced_animations.shaders.PINK_PAINT_SHADER

fun Modifier.pinkPaintShader(): Modifier = composed {

    val shader = remember { RuntimeShader(PINK_PAINT_SHADER) }
