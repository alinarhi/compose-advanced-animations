...
import ru.edu.hse.advanced_animations.shaders.FLYING_HEARTS_SHADER


fun Modifier.flyingHeartsShader(
): Modifier = composed {

    val shader = remember { RuntimeShader(FLYING_HEARTS_SHADER) }
